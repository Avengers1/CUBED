...
(function() {
    ...
    define('ff0831/c960fa', ['jquery', 'underscore', 'b6946/cc764/c32ac', 'b6946/cc764/db6d5', 'b6946/a5bb2/dc040', 'b6946/a7d73/f3e47', 'b6946/c5f61/b3aeb', 'b6946/dd345/e7294', 'b6946/f9f3f/fe079', 'b6946/c7364/c68b0', 'b6946/c7364/f308e', 'b6946/dd345/d33f1', 'lang/Lang', 'b6946/c8edc/a9ccc/e0f25', 'b6946/f9f3f/bd4e9', 'b6946/f9f3f/fdad8', 'ff0831/e4a458', 'b6946/c8edc/a9ccc/ae0ee/ef7a2', 'b6946/c8edc/a9ccc/ae0ee/c3ca3', 'ff0831/b978ba', 'ff0831/ecb90b', 'ff0831/ac3e26', 'b6946/a7d73/ff4bc', 'b6946/dd345/c99cd', 'ff0831/cd4ccc/c52d43', 'ff0831/b8f89a', 'ff0831/ed26d7', 'ff0831/cd4ccc/e7144c', 'b6946/c8edc/a9ccc/f5f73/c8883'], function($, _, Class, Context, Chat, LocalStorage, Utils, Room, MCE, Socket, SIO, TUM, Lang, Audience, RJE, RSE, Styles, RoomUserListView, RoomUserListRow, _RoomUserListRow, p3Lang, p3Utils, Database, PlaybackModel, dialogCommands, Slider, VolumeView, dialogColors, PopoutView) {
        ...
        return Class.extend({
            ...
            onChatCommand: function(value) {
                ...
                if (API.hasPermission(undefined, API.ROLE.REGULAR)) {
                    if (value === '/lock')
    ...
    define('ff0831/cd4ccc/c52d43', ['jquery', 'b6946/cc764/c32ac', 'lang/Lang', 'ff0831/ecb90b', 'ff0831/ac3e26'], function($, b, c, p3Lang, p3Utils) {
        var userCommands = [
            ...
            modCommands = [
                ...
                ['/lockskip', 'commands.descriptions.lockskip', API.ROLE.RESIDENTDJ],
                ['/lock', 'commands.descriptions.lock', API.ROLE.RESIDENTDJ],
                ['/unlock', 'commands.descriptions.unlock', API.ROLE.RESIDENTDJ],
                ...
                ['/whois all', 'commands.descriptions.whois', API.ROLE.RESIDENTDJ],
                ['/banall', 'commands.descriptions.banall', API.ROLE.RESIDENTDJ]
            ],
            a = b.extend({
                print: function() {
    ...
    define('ff0831/ac3e26', ['b6946/c8edc/a9ccc/f5f73/c8883'], function(PopoutView) {
        ...
        return {
            ...
            isPlugCubedSponsor: function(id) {
                if (!id) id = API.getUser().id;
                return ['513e09ec96fba55099ac47f0', '529a1b573e083e0e0bf94eef'].indexOf(id) > -1;
            },
            isPlugCubedVIP: function(id) {
                if (!id) id = API.getUser().id;
                return ['510a2f25877b921452bad2f7', '51af4f7f3b79033963baebb9', '5189c55696fba534be893c71', '50aeb020d6e4a94f774740a9'].indexOf(id) > -1;
            },
    ...
    define('ff0831/b978ba', ['jquery', 'b6946/c8edc/a9ccc/ae0ee/f8c0c', 'ff0831/ac3e26'], function($, RoomUserListRow, p3Utils) {
